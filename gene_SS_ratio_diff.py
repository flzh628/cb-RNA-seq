...
parser = argparse.ArgumentParser(description='To identify the differential SS-ratio genes.',
                                 epilog='Author: Fengli Zhao\tzhaofl@sustech.edu.cn      20220801 20220401')

parser.add_argument('--ss_res', type=str, required=True, help='The file of two-sample gene SS-ratio. The result of intronSS_2_GeneLevel.py ')
...
while True:
    ...
    if 'LOC' in arr[0]:
        ...
        if arr[6] == arr[7] and arr[6] == 'unknown':
            continue
        elif arr[8] == arr[9] and arr[8] == 'unknown':
            continue
        else:
